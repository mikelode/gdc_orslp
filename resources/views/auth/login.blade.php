...
@section('content')
<body class="login-page" style="background: #182335;">
    <div class="container">
        <div id="loginbox" style="margin-top:10%;" class="mainbox col-md-6 col-md-offset-3 col-sm-8 col-sm-offset-2">
            <div class="panel panel-info" >
                <div class="panel-heading">
                    <div class="panel-title">Login - Gestión Documentaria AGROIDEAS</div>
                    <div style="float:right; font-size: 80%; position: relative; top:-10px"></div>
                </div>
                <div style="padding-top:20px" class="panel-body" >
                    <div style="display:none" id="login-alert" class="alert alert-danger col-sm-12"></div>
                    <div class="col-md-4">
                        <img src="{{ asset('img/agroideas.jpg') }}" width="150" height="150" />
                    </div>
                    <div class="col-md-8">
                    @if (count($errors) > 0)
